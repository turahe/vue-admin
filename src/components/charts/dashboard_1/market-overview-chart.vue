...
export default {
  extends: Bar,
  data: function () {
    const MarketingData1 = [145, 238, 148, 293, 242, 235, 256, 334]
    const MarketingData2 = [330, 380, 230, 400, 309, 430, 340, 310]
    const MarketingData3 = [375, 440, 284, 450, 386, 480, 400, 365]
    const MarketingData4 = [425, 480, 324, 490, 426, 520, 440, 405]
    return {
      gradient: null,
      gradient2: null,
      datacollection: {
