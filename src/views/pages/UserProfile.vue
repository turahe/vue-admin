          ...
          <div class="profile-header text-white">
            <div class="d-flex justify-content-center justify-content-md-between mx-4 mx-xl-5 px-xl-5 flex-wrap">
              <div class="profile-info d-flex align-items-center justify-content-center flex-wrap mr-sm-3">
                <img class="rounded-circle img-lg mb-3 mb-sm-0" src="@/assets/images/faces/profile/profile.jpg"
                     alt="profile image">
                <div class="wrapper pl-sm-4">
                  ...
                  <div class="wrapper d-flex align-items-center justify-content-center flex-wrap">
                    <p class="profile-user-designation text-center text-md-left my-2 my-md-0">User Experience
                      Specialist</p>
            ...
            <div class="row">
                        ...
                        <div class="row">
                          <div class="col-12">
                            <img class="img-fluid rounded"
                                 src="@/assets/images/samples/profile_page/banner_01.jpg" alt="banner image">
                          </div>
                          <div class="col-12 mt-3">
                            <img class="img-fluid rounded"
                                 src="@/assets/images/samples/profile_page/banner_02.jpg" alt="banner image">
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-12 mt-5">
                        ...
                        <div class="stage-wrapper pl-4">
                          <div class="stages border-left pl-5 pb-4">
                            ...
                            <p>Admin is a full featured, multipurpose, premium bootstrap admin template built with
                          ...
                          <div class="stages border-left pl-5 pb-4">
                            ...
                            <p>one of the best admin panel templates. With this bootstrap admin template, you can quick
                  ...
                  <div class="tab-pane fade" id="user-profile-activity" role="tabpanel"
                    ...
                    <div class="horizontal-timeline">
                      <section class="time-frame">
                        ...
                        <div class="event">
                          <p class="event-text">Admin is a full featured, multipurpose, premium bootstrap admin template
                            built with Bootstrap 4 Framework</p>
                          <div class="tumbnail-views">
                            <div class="thumbnail">
                              <img src="@/assets/images/samples/profile_page/thumbnail/01.jpg" alt="thumbnail">
                            </div>
                            <div class="thumbnail">
                              <img src="@/assets/images/samples/profile_page/thumbnail/02.jpg" alt="thumbnail">
                            </div>
                            <div class="thumbnail">
                              <img src="@/assets/images/samples/profile_page/thumbnail/03.jpg" alt="thumbnail">
                            </div>
                            <div class="thumbnail">
                              <img src="@/assets/images/samples/profile_page/thumbnail/04.jpg" alt="thumbnail">
                            </div>
                            <div class="thumbnail">
                              <img src="@/assets/images/samples/profile_page/thumbnail/05.jpg" alt="thumbnail">
                            </div>
                            <div class="thumbnail">
                              <img src="@/assets/images/samples/profile_page/thumbnail/06.jpg" alt="thumbnail">
                            </div>
                          </div>
                          <div class="event-info">New Dashboard Design - 9:24 PM</div>
                        </div>
                        <div class="event">
                          <p class="event-text">It is a fully responsive bootstrap admin template / bootstrap admin
                            dashboard</p>
                          <div class="event-alert">You have added task #26 Successfully to the project “Agile CRM”</div>
                          <div class="event-info">New Dashboard Design - 9:24 PM</div>
                        </div>
                      ...
                      <section class="time-frame">
                        ...
                        <div class="event">
                          <p class="event-text">Why waste time starting from scratch; try out our admin dashboard
                            template</p>
                      ...
                      <section class="time-frame">
                        ...
                        <div class="event">
                          ...
                          <div class="tumbnail-views">
                            <div class="thumbnail">
                              <img src="@/assets/images/samples/profile_page/thumbnail/07.jpg" alt="thumbnail">
                            </div>
                            <div class="thumbnail">
                              <img src="@/assets/images/samples/profile_page/thumbnail/08.jpg" alt="thumbnail">
                            </div>
                            <div class="thumbnail">
                              <img src="@/assets/images/samples/profile_page/thumbnail/09.jpg" alt="thumbnail">
                            </div>
                            <div class="thumbnail">
                              <img src="@/assets/images/samples/profile_page/thumbnail/10.jpg" alt="thumbnail">
                            </div>
                            <div class="thumbnail">
                              <img src="@/assets/images/samples/profile_page/thumbnail/11.jpg" alt="thumbnail">
                            </div>
                            <div class="thumbnail">
                              <img src="@/assets/images/samples/profile_page/thumbnail/12.jpg" alt="thumbnail">
                            </div>
                          </div>
                          <div class="event-alert">You have added task #26 Successfully to the project “Agile CRM”</div>
              ...
              <div class="col-md-3">
                ...
                <div class="new-accounts">
                  <ul class="chats">
                    <li class="chat-persons" v-for="user in followers" :key="user.id">
                      <a :href="user.url">
                        <span class="pro-pic">
                          <img :src="user.avatar_url" :alt="user.login">
                        </span>
                        <div class="user">
                          <p class="u-name">{{ user.login }}</p>
...
export default {
  ...
  methods: {
    getFollowers () {
      axios.get('https://api.github.com/users/turahe/followers')
        .then(response => {
