            ...
            <div class="card-body">
              ...
              <div class="template-demo">
                <button type="button" class="btn btn-light btn-fw">
                  <i class="fa fa-heart-outline"></i>Default</button>
                <button type="button" class="btn btn-primary btn-fw">
                  <i class="fa fa-star-outline"></i>Primary</button>
                ...
                <button type="button" class="btn btn-secondary btn-fw">
                  <i class="fa fa-file-document"></i>Submit</button>
                <button type="button" class="btn btn-dark btn-fw">
                  <i class="fa fa-cloud-download"></i>Edit</button>
                <button type="button" class="btn btn-danger btn-fw">
                  <i class="fa fa-alert-outline"></i>Warning</button>
