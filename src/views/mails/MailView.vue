<template>
  <div class="email-wrapper wrapper">
    <div class="mail-sidebar bg-white">
      <div class="menu-bar">
        <ul class="menu-items">
        ...
        <ul class="profile-list d-none d-md-block">
          ...
          <li class="profile-list-item">
            <a href="#">
              <img class="img-xs rounded-circle" src="../../assets/images/faces/face10.jpg" alt="">
              <div class="user">
          ...
          <li class="profile-list-item">
            <a href="#">
              <img class="img-xs rounded-circle" src="../../assets/images/faces/face23.jpg" alt="">
              <div class="user">
          ...
          <li class="profile-list-item">
            <a href="#">
              <img class="img-xs rounded-circle" src="../../assets/images/faces/face11.jpg" alt="">
              <div class="user">
          ...
          <li class="profile-list-item">
            <a href="#">
              <img class="img-xs rounded-circle" src="../../assets/images/faces/face9.jpg" alt="">
              <div class="user">
    ...
    <div class="email-view-wrapper">
      <div class="mail-list-container">
        <div class="border-bottom pt-4 pb-4 mb-3 px-3 d-flex align-items-center">
          <div class="form-group mb-0 w-100 mr-4 mr-md-0">
            <input class="form-control w-100" type="search" placeholder="Search mail" id="Mail-rearch">
          </div>
          <div class="aside-toggler btn btn-secondary btn-icons ml-auto d-md-none">
      ...
      <div class="mail-view">
        <div class="mail-header-toolbar">
          <button type="button" class="btn btn-icons btn-rounded btn-secondary mail-back-button mr-3"><i class="mdi mdi-arrow-left"></i></button>
          <div class="wrapper">
        ...
        <div class="message-body">
          ...
          <div class="message-content">
            ...
            <p>For the coming week the highest priority is given to the development for <a href="#" target="_blank">http://www.bootstrapdash.com/</a> once the design is approved and necessary improvements are made.</p>
            <p>
              <br>
              <br>Regards, <br>Sarah Graves</p>
          </div>
